...
[![npm](https://img.shields.io/npm/v/@nimbus/token-lists)](https://unpkg.com/@nimbus/token-lists@latest/)
...
```typescript
import { TokenList, schema } from '@nimbus/token-lists'
