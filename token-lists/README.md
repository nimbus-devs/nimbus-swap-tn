# nimbus-swap-tn/token-lists (beta)
...
[![npm](https://img.shields.io/npm/v/nimbus-swap-tn/token-lists)](https://unpkg.com/nimbus-swap-tn/token-lists@latest/)
...
```typescript
import { TokenList, schema } from 'nimbus-swap-tn/token-lists'
